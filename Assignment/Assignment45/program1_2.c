...
int First_Occ(PNODE first ,int no)
{
    int iPos = 1;
     while ( first != NULL)
    {
...
int main()
{
    ...
    for(iCnt = 1 ; iCnt <= iNo ; iCnt++)
    {
     ...
     printf(" Element for First Occ: ");
    scanf("%d",&iValue);
     
  
    iRet = First_Occ(head ,iValue );
    ...
    {
        printf(" first Element are found %d positon \n" , iRet);
...
Enter element 4: 2
Enter element 5: 5
 Element for First Occ: 2
 first Element are found 2 positon
